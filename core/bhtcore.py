...
___  _    ____ ____ _  _ _  _ ____ _    ____ 
|__] |    |__| |    |_/  |__| |  | |    |___ 
|__] |___ |  | |___ | \_ |  | |__| |___ |___ 
                                             
"""
print ('\33[33m' + 'GitHub:' + '\x1b[0m' + '\033[4m' + 'https://github.com/SenpaiGblk' + '\x1b[0m')

backtomenu_banner = """
  [99] Back to main menu
  [00] Exit the BlackHole
"""
def restart_program():
...
def hiddeneyeee():
	...
	os.system('chmod 777 HiddenEye.py')
	print '###### Done'
	backtomenu_option()
...
def toolxx():
	...
	os.system('cd Tool-X')
	os.system('chmod 777 install.aex')
	os.system('./install.aex')
	print 'Type Tool-X for run'
	print '###### Done'
	backtomenu_option()
...
def osmedeus():
	print '\n###### Installing Osmedeus'
	os.system('apt update && apt upgrade')
	os.system('git clone https://github.com/j3ssie/Osmedeus')
	os.system('pip install -r requirements.txt')
...
def starkk():
	print '\n###### Installing Stark'
	os.system('apt update && apt upgrade')
	os.system('git clone https://github.com/aniketstark/STARK2.0')
	os.system('cd STARK2.0')
