...
def main():
	...
	print "   [08] Other\n"
	print "   [09] My Favorite"
	
	print "   [10] Exit the BlackHole\n"
	blackhole = raw_input("[Select]##> ")
	
	if blackhole == "1" or blackhole == "01":
		os.system ("clear")
		print "\n    [01] Nmap"
		print "    [02] Red Hawk"
		print "    [03] D-Tect"
		...
		infogathering = raw_input("[Select]##> ")
	...
	elif blackhole == "2" or blackhole == "02":
		os.system ("clear")
		print "\n    [01] Nmap"
	...
	elif blackhole == "3" or blackhole == "03":
		os.system ("clear")
		print "\n    [01] Torshammer"
		print "    [02] Slowloris"
	...
	elif blackhole == "4" or blackhole == "04":
		os.system ("clear")
		print "\n    [01] Hydra"
		print "    [02] FMBrute"
		print "    [03] HashID"
	...
	elif blackhole == "5" or blackhole == "05":
		os.system ("clear")
		print "\n    [01] sqlmap"
		print "    [02] Webdav"
		print "    [03] xGans"
	...
	elif blackhole == "6" or blackhole == "06":
		os.system ("clear")
		print "\n    [01] Metasploit"
		print "    [02] commix"
		print "    [03] sqlmap"
	...
	elif blackhole == "7" or blackhole == "07":
		os.system ("clear")
		print "\n    [01] KnockMail"
	...
	elif blackhole == "8" or blackhole == "08":
		os.system ("clear")
		print "\n    [01] SpiderBot"
		print "    [02] Ngrok"
		print "    [03] Sudo"
	...
	elif blackhole == "9" or blackhole == "09":
		os.system ("clear")
		print "	[01] HiddenEye"
		print "	[02] Tool X"
		print "	[03] Trape"
		...
		print "	[05] Stark"
		print "	[00] Back to main menu"
		myfav = raw_input("[Select]##> ")
		
		if myfav == "01" or myfav == "1":
			hiddeneyeee()
		elif myfav == "02" or myfav == "2":
			toolx
		elif myfav == "03" or myfav == "3":
			trapee()
		elif myfav == "04" or myfav == "4":
			osmedeus()
		elif myfav == "05" or myfav == "5":
			starkk()
		elif myfav == "00" or myfav == "0":
			restart_program()
		else:
			print "\nERROR: Wrong Input"
			timeout(2)
